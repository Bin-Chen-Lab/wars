...
load(paste(subset_comparison_id, '/',subset_comparison_id,'_',analysis_id,'_randoms.RData',sep=""))
...
save(results, file=paste(subset_comparison_id, "/", "cmap_predictions.RData", sep=""))
