# Computes the random distribution of the Connectivity Map scores. 
...
save(rand_cmap_scores,file=paste(subset_comparison_id, '/',subset_comparison_id,'_',analysis_id,'_randoms.RData',sep=""))
